...
export function TransactionsView() {
  ...
  const transactionsData: TransactionItem[] = [
    {
      ...
      rawLabel: "CB CARREFOUR EXPRESS PARIS 15 28/07",
    ...
    {
      id: 2,
      merchant: "Virement Salaire TechCorp",
      rawLabel: "VIR SEPA SALAIRE TECHCORP SAS",
    ...
    {
      id: 3,
      merchant: "TotalEnergies Relais",
      rawLabel: "CB TOTAL ENERGIES RELAIS PARIS",
    ...
    },
    {
      id: 4,
      merchant: "Uber Eats",
      rawLabel: "CB UBER EATS HELP.UBER.COM",
      date: "28 Juillet 2026",
      time: "21:10",
      amount: -29.9,
      category: "Alimentation",
    ...
    },
    {
      id: 5,
      merchant: "Netflix",
      rawLabel: "PRLV NETFLIX INTERNATIONAL",
    ...
    {
      id: 6,
      merchant: "Fnac Montparnasse",
      rawLabel: "CB FNAC MONTPARNASSE HIFI",
      ...
      account: "BoursoBank",
      icon: ShoppingBag,
      project: "Matériel Informatique",
    },
    {
      id: 7,
      merchant: "Loyer Appartement",
      rawLabel: "PRLV LOYER GESTION IMMO",
  ...
  // Group by date
  const groupedByDate: Record<string, TransactionItem[]> = {}
  ...
  return (
    <div className="flex flex-col gap-6 w-full max-w-7xl mx-auto pb-24 md:pb-8">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        {/* Granularity Tabs (Jour, Mois, Année) */}
